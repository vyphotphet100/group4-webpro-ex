package com.group4.ex9_1.download;

import com.group4.ex9_1.business.User;
import com.group4.ex9_1.data.UserIO;
import com.group4.ex9_1.util.CookieUtil;
...
@WebServlet(urlPatterns = {"/ex9_1/download", "/ex9_1/"})
public class DownloadServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request,
        ...
        String url = "/ex9_1/index.jsp";
        if (action.equals("viewAlbums")) {
            url = "/ex9_1/index.jsp";
        } else if (action.equals("checkUser")) {
            url = checkUser(request, response);
        } else if (action.equals("viewCookies")) {
            url = "/ex9_1/view_cookies.jsp";
    ...
    private String checkUser(HttpServletRequest request,
        ...
        if (user == null) {
            ...
            // if cookie exists, create User object and go to Downloads page
                ...
                url = "/ex9_1/" + productCode + "_download.jsp";
            }
        } 
    ...
    private String registerUser(HttpServletRequest request,
        ...
        String url = "/ex9_1/" + productCode + "_download.jsp";
        return url;
    }
    ...
    private String deleteCookies(HttpServletRequest request,
        ...
        String url = "/ex9_1/delete_cookies.jsp";
        return url;
    }
}